...
from logic.speech2text_deepspeech import DeepSpeechSpeechToText
...
class ProcessAudioEndpoint(Resource):
    ...
    def post(self, file_id):
        ...
        deepspeechS2T = DeepSpeechSpeechToText(audio_file_path)
        file_to_process.set_text(deepspeechS2T.transcript_audio())
